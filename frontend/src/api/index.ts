...
export const practiceAPI = {
  ...
  getDailyGrammar: () => api.get('/generate/daily-grammar'),
  generateMoreGrammar: () => api.post('/generate/generate-more-grammar'),
  submitAIGrammar: (
    practiceId: number,
    userAnswers: string,
    score: number,
    correctCount: number,
    totalQuestions: number,
  ) => api.post('/generate/submit-ai-grammar', {
    practice_id: practiceId,
    user_answers: userAnswers,
    score,
    correct_count: correctCount,
...
export const topicsAPI = {
  ...
  create: (data: { title: string; content: string; content_zh?: string; example?: string; skill?: string; category?: string; phonetic?: string; audio_url?: string }) =>
